                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted small">Accédez à votre espace gourmand</p>
                        </div>
                        ...
                        <form action="/connexion/" method="POST">
                            ...
                            <div class="text-center border-top pt-4">
                                <p class="text-muted small mb-0">Nouveau client ? <a href="/inscription" class="fw-bold text-decoration-none" style="color: var(--accent-color);">Créer un compte</a></p>
                            </div>
                        </form>
                    </div>
                </div>
